...
abstract class BaseNewsletterFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ist_gesendet' => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'ist_gesendet' => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
